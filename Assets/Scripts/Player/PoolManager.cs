...
public class PoolManager : MonoBehaviour
{
    ...
    #region ObjectPoolContainer Class
...
/*
    PoolManager.WarmPool(Prefab, 20);       //预先制造
    PoolManager.SpawnObject(Prefab,Pos,Rotation)    //从池中取出
    PoolManager.ReleaseObject(gameObject);  //放入池中
*/
